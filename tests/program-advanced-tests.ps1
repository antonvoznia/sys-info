...
function Test-MemUsage200MB {
    $pwsh = Start-Process $PWSHFullName -ArgumentList "-Command", "[void]('x' * (50 * 1024 * 1024)); sleep 30" -WindowStyle Hidden -PassThru
    ...
    EvalTest $MyInvocation.MyCommand.Name ($memUsage -ge 50)
